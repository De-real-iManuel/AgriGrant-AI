...
function ApplicationsContent() {
  ...
  const fetchApplications = useCallback(async () => {
    ...
    try {
      ...
      setError(
        "We couldn't load your applications right now. Please check your connection and try again."
      );
    } finally {
      setIsLoading(false);
    }
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b" style={{ backgroundColor: 'var(--muted)' }}>
                  ...
                  <th
                    className="py-3 px-5 text-xs font-semibold uppercase tracking-wider text-right"
                    style={{ color: 'var(--muted-foreground)' }}
                  >
                    View
                  </th>
                    ...
                    <tr key={app.id} className="hover:bg-muted/30 transition-colors">
                      ...
                      <td className="py-4 px-5 text-right">
                        <Link
                          ...
                          className="p-2 rounded-lg inline-flex transition-colors hover:bg-primary/10"
  ...
  return (
    <AuthGuard>
      <DashboardShell
        ...
        subtitle="Track every grant search and AI pipeline run you have submitted."
      >
        <ApplicationsContent />
      </DashboardShell>
    </AuthGuard>
