...
function ProposalsContent() {
  ...
  const fetchProposals = useCallback(async () => {
    ...
    try {
      ...
      setError(
        "We couldn't load your proposals right now. Please check your connection and try again."
      );
    } finally {
      setIsLoading(false);
    }
        ...
        <div className="card-elevated py-16 flex flex-col items-center gap-4 text-center">
          ...
          <div>
            ...
            <p className="text-sm mt-1 max-w-sm" style={{ color: 'var(--muted-foreground)' }}>
              Run a grant discovery in the Farmer Portal. When the AI finds matches, it will
              automatically generate a grant proposal letter for you here.
            </p>
          </div>
              ...
              <div key={prop.id} className="card-elevated relative overflow-hidden p-0">
                ...
                <div className="p-5">
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                    ...
                    <span
                      className={`flex-shrink-0 px-2.5 py-1 rounded-full text-xs font-semibold ${prop.hasLetter ? 'bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400' : 'bg-amber-50 dark:bg-amber-900/20 text-amber-700 dark:text-amber-400'}`}
                    >
                  ...
                  {isOpen && prop.proposalText && (
                    <div
                      className="mt-4 p-4 rounded-xl text-sm leading-relaxed whitespace-pre-wrap font-mono border"
                      style={{
  ...
  return (
    <AuthGuard>
      <DashboardShell
        ...
        subtitle="AI-generated grant proposals from your discovery sessions. Download or share with grantors."
      >
        <ProposalsContent />
      </DashboardShell>
    </AuthGuard>
