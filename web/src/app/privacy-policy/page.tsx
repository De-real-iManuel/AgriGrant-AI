    ...
    <div className="min-h-screen" style={{ backgroundColor: '#ffffff' }}>
      ...
      <main className="max-w-3xl mx-auto px-6 py-12 flex flex-col gap-7">
        ...
        <div className="flex flex-col gap-3">
          <P>
            This Privacy Notice for <strong>REM Labs LLC</strong> (&quot;we&quot;, &quot;us&quot;,
          ...
          <UL>
            <LI>
              Visit our website at <A href="http://agrigrant.xyz/">http://agrigrant.xyz/</A> or any
              website of ours that links to this Privacy Notice
            </LI>
            <LI>
              Use <strong>AgriGrant AI</strong> — an end-to-end intelligent platform that helps
              Nigerian smallholder farmers discover, assess eligibility for, and submit agricultural
              grant applications in under 10 minutes, built on UiPath Agentic Automation
              orchestrating five specialised AI agents.
            </LI>
          ...
          <P>
            ...
            practices, please do not use our Services. If you still have questions, please contact
            us at <A href="mailto:info@agrigrant.xyz">info@agrigrant.xyz</A>.
          </P>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <P>
            <em>
              <strong>This summary provides key points from our Privacy Notice.</strong>
            </em>
          </P>
          <P>
            <strong>What personal information do we process?</strong> We may process personal
            information depending on how you interact with us and the Services, the choices you
          ...
          <P>
            ...
            be considered &apos;special&apos; or &apos;sensitive&apos; in certain jurisdictions. We
            may process sensitive personal information when necessary with your consent or as
          ...
          <P>
            <strong>How do you exercise your rights?</strong> The easiest way is by contacting us at{' '}
            <A href="mailto:info@agrigrant.xyz">info@agrigrant.xyz</A>. We will consider and act
        ...
        <div className="flex flex-col gap-3" id="infocollect">
          ...
          <P>
            ...
            collect may include: names, phone numbers, email addresses, mailing addresses,
            passwords, contact preferences, billing addresses, debit/credit card numbers, contact or
            authentication data.
          </P>
          <P>
            <strong>Sensitive Information.</strong> When necessary, with your consent or as
            otherwise permitted by applicable law, we process: social security numbers or other
            government identifiers; information revealing trade union membership.
          </P>
          <P>
            <strong>Payment Data.</strong> We may collect data necessary to process your payment if
            you choose to make purchases. All payment data is handled and stored by{' '}
            <strong>Paystack</strong>. You may find their privacy notice at:{' '}
            <A href="https://paystack.com/privacy/merchant">
          ...
          <P>
            <em>
              <strong>In Short:</strong> Some information — such as your IP address and/or browser
          ...
          <UL>
            <LI>
              <em>Log and Usage Data.</em> Service-related, diagnostic, usage, and performance
              information our servers automatically collect when you access or use our Services,
              including IP address, device information, browser type, pages and files viewed,
              searches, and other actions.
            </LI>
            <LI>
        ...
        <div className="flex flex-col gap-3" id="infouse">
          ...
          <UL>
            <LI>
              <strong>To facilitate account creation and authentication</strong> — so you can create
              and log in to your account.
            </LI>
            <LI>
              <strong>To deliver and facilitate delivery of services to the user</strong> — to
              provide you with the requested service.
            </LI>
            <LI>
              <strong>To send administrative information to you</strong> — including details about
              our products and services, changes to our terms and policies.
            </LI>
            <LI>
            ...
            <LI>
              <strong>To comply with our legal obligations</strong> — to comply with our legal
              obligations, respond to legal requests, and exercise, establish, or defend our legal
              rights.
            </LI>
          </UL>
        </div>
        ...
        <div className="flex flex-col gap-3" id="whoshare">
          ...
          <UL>
            ...
            <LI>
              <strong>When we use Google Maps Platform APIs.</strong> We may share your information
              with certain Google Maps Platform APIs. We obtain and store on your device
              (&apos;cache&apos;) your location for three (3) months. You may revoke your consent
              anytime by contacting us.
            </LI>
            <LI>
              <strong>Affiliates.</strong> We may share your information with our affiliates, in
              which case we will require those affiliates to honour this Privacy Notice.
            </LI>
            <LI>
        ...
        <div className="flex flex-col gap-3" id="cookies">
          ...
          <P>
            ...
            advertisements or tailor advertisements to your interests.
          </P>
          <P>
            Specific information about how we use such technologies and how you can refuse certain
            cookies is set out in our <A href="/cookie-policy">Cookie Policy</A>.
          </P>

          <H3>Google Analytics</H3>
          <P>
            We may share your information with Google Analytics to track and analyse the use of the
            Services, including Google Analytics Demographics and Interests Reporting. To opt out of
        ...
        <div className="flex flex-col gap-3" id="ai">
          ...
          <P>
            As part of our Services, we offer AI Products designed to enhance your experience. The
            terms in this Privacy Notice govern your use of the AI Products within our Services.
          </P>
          <P>
            <strong>Use of AI Technologies.</strong> We provide the AI Products through third-party
            service providers (&apos;AI Service Providers&apos;), including <strong>OpenAI</strong>{' '}
            and <strong>Anthropic</strong>. Your input, output, and personal information will be
            shared with and processed by these AI Service Providers. You must not use the AI
            Products in any way that violates the terms or policies of any AI Service Provider.
          </P>
          <P>
            <strong>Our AI Products</strong> are designed for: AI automation, AI applications, and
            natural language processing.
          </P>
          <P>
            <strong>How We Process Your Data Using AI.</strong> All personal information processed
            using our AI Products is handled in line with our Privacy Notice and our agreement with
            third parties. This ensures high security and safeguards your personal information
        ...
        <div className="flex flex-col gap-3" id="inforetain">
          ...
          <P>
            <em>
              <strong>In Short:</strong> We keep your information for as long as necessary to fulfil
          ...
          <P>
            ...
            we will either delete or anonymise such information, or securely store your personal
        ...
        <div className="flex flex-col gap-3" id="infominors">
          ...
          <P>
            ...
            minor and consent to such minor dependent&apos;s use of the Services. If you become
            aware of any data we may have collected from children under age 18, please contact us at{' '}
            <A href="mailto:info@agrigrant.xyz">info@agrigrant.xyz</A>.
          </P>
        </div>
        ...
        <div className="flex flex-col gap-3" id="privacyrights">
          ...
          <P>
            ...
            or by contacting us. You will then be removed from the marketing lists. However, we may
            still communicate with you for service-related purposes.
          </P>
          ...
          <P>
            ...
            choose to set your browser to remove or reject cookies. If you choose to remove or
        ...
        <div className="flex flex-col gap-3" id="DNT">
          ...
          <P>
            ...
            implementing DNT signals has been finalised. As such, we do not currently respond to DNT
        ...
        <div className="flex flex-col gap-3" id="otherlaws">
          ...
          <P>
            <em>
              <strong>In Short:</strong> You may have additional rights based on the country you
              reside in.
            </em>
          </P>
          ...
          <P>
            ...
            information. You can make such a request by contacting us using the contact details
            provided in section 14 below.
          </P>
          <P>
            If you are unsatisfied with the manner in which we address any complaint with regard to
            our processing of personal information, you can contact the office of the regulator:
          </P>
          <P>
            <A href="https://inforegulator.org.za/">The Information Regulator (South Africa)</A>
          </P>
          <P>
            General enquiries:{' '}
        ...
        <div className="flex flex-col gap-3" id="contact">
          ...
          <P>
            ...
            <A href="mailto:info@agrigrant.xyz">info@agrigrant.xyz</A> or contact us by post at:
          </P>
        ...
        <div className="flex flex-col gap-3" id="request">
          ...
          <P>
            ...
            to withdraw your consent to our processing of your personal information. These rights
