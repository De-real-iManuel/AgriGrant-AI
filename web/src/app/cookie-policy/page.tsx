  ...
  return (
    <section className="flex flex-col gap-3">
      ...
      <div
        ...
        style={{ color: '#595959', fontFamily: 'Arial, sans-serif' }}
      >
        {children}
      </div>
    </section>
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#ffffff' }}>
      ...
      <main className="max-w-3xl mx-auto px-6 py-12 flex flex-col gap-8">
        ...
        >
          <p>
            This Cookie Policy explains how <strong>REM Labs LLC</strong> (&quot;Company,&quot;
        ...
        <Section title="What are cookies?">
          ...
          <p>
            Cookies set by the website owner (in this case, <strong>REM Labs LLC</strong>) are
        ...
        <Section title="Do you use Flash cookies or Local Shared Objects?">
          ...
          <p>
            ...
            placed on your computer without your being asked, and how to block Flash Cookies that
